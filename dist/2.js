...
class UrlChangeTracker {
  ...
  constructor(tracker, opts) {
    ...
    this.opts = /** @type {UrlChangeTrackerOpts} */ (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utilities__["b" /* assign */])(defaultOpts, opts));
    ...
    setTimeout(() => {
      ...
      if (oldPath != newPath &&
        ...
        if (historyDidUpdate || this.opts.trackReplaceState) {
          ...
          this.tracker.send('pageview', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utilities__["d" /* createFieldsObj */])(defaultFields,
